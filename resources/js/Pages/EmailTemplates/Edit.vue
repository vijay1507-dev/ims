        ...
        <div class="p-6 max-w-5xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <div class="flex justify-between items-end">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-900">Modify Template</h2>
                        <p class="text-gray-600 mt-1">Updating: {{ template.name }}</p>
                    </div>
                </div>
            </div>
...
const initJodit = () => {
    if (typeof window.Jodit === 'undefined') {
        if (!document.getElementById('jodit-script')) {
            ...
            // Script already exists, wait for it to load if not already
