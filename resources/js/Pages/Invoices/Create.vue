<template>
    <AppLayout>
        <div class="max-w-4xl mx-auto p-6">
            ...
            <div class="mb-6">
                <Link 
                    :href="form.redirect_customer_id ? `/customers/${form.redirect_customer_id}/edit` : '/invoices'" 
                    class="inline-flex items-center text-sm font-medium text-indigo-600 hover:text-indigo-800 transition-colors mb-2"
                >
                    <i class="fas fa-arrow-left mr-2 text-xs"></i> 
                    Back to {{ form.redirect_customer_id ? 'Customer Profile' : 'Invoices Dashboard' }}
                </Link>
                <h2 class="text-2xl font-bold text-gray-900">Generate Client Invoice</h2>
                <p class="text-gray-600 mt-1">Provision manual billing allocations and itemized custom sums.</p>
            </div>
                    ...
                    <div class="p-6 sm:p-8 space-y-6">
                        ...
                        <div class="border-b border-gray-100 pb-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                                <div>
                                    <label class="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-1.5">Initial Tracking Status</label>
                                    <select
                                        v-model="form.status"
