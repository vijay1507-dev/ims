    ...
    <AppLayout>
        <div class="max-w-4xl mx-auto p-6">
            <div class="mb-8 flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Edit Role Permissions</h2>
                    <p class="text-sm text-gray-500 mt-1">Configure granular access levels for the <span class="font-bold text-indigo-600">{{ role.name }}</span> role</p>
                </div>
...
const submit = () => {
    form.post(`/users/roles/${props.role.id}/permissions`);
};
</script>
