    ...
    <AppLayout>
        <div class="max-w-3xl mx-auto p-6">
            <div class="mb-6">
                ...
                <h2 class="text-2xl font-bold text-gray-900">Edit Sub-Customer</h2>
...
const form = useForm({
    name: props.subCustomer.name,
    email: props.subCustomer.email,
    phone: props.subCustomer.phone,
    address: props.subCustomer.address,
    status: props.subCustomer.status,
});

const submitForm = () => {
    form.put(`/sub-customers/${props.subCustomer.id}`);
};
</script>
